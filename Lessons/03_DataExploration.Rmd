...
> Answer: it will showed in the console
...
> ANSWER: It can be found here: https://waterdata.usgs.gov/nwis 
It has a complete dataset and ready to be analyzed.The Data-value qualification codes are included in this output:
...
> Answer: how to know data for gage station for river in the past. NAs in dataset is usually retained in Time series analysis.
